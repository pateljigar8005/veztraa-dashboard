...
// ** Advanced search field config for this list
const searchFields = [
  {
    name: 'user_id',
    label: 'User',
    ...
    fetchOptions: () =>
      axios
        ...
        .then(response => response.data.data.users.map(u => ({ value: u.id, label: u.fullName })))
  },
  {
    name: 'project_id',
    label: 'Project',
    ...
    fetchOptions: () =>
      axios
        ...
        .then(response => response.data.data.projects.map(p => ({ value: p.id, label: p.name })))
  },
  {
    name: 'activity_id',
    label: 'Activity',
    ...
    fetchOptions: () =>
      axios
        ...
        .then(response => response.data.data.timesheetActivities.map(a => ({ value: a.id, label: a.name })))
  },
