...
import { quotationStatusOptions, currencyOptions } from '../documentOptions'
...
const searchFields = [
  { name: 'status', label: 'Status', type: 'select', options: quotationStatusOptions },
  {
    name: 'client_id',
    label: 'Client',
    type: 'select',
  ...
  { name: 'valid_until', label: 'Valid Until', type: 'date-range' },
