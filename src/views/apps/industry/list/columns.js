...
export const columns = [
  {
    ...
    cell: row => (
      <Link to={`/industry/edit/${row.id}`} className='user_name text-truncate text-body'>
  ...
  },
  {
    ...
    cell: row => (
      <div className='column-action d-flex align-items-center'>
        ...
        {currentUserCan('/industry', 'delete') && (
          <Fragment>
            <Button
              tag='a'
              href='/'
              ...
              onClick={e => {
                ...
                confirmDelete({
                  ...
                  onConfirm: () =>
                    store.dispatch(deleteIndustry(row.id)).unwrap().then(() => toast.success('Industry deleted')).catch(err => toast.error(err?.message || 'Failed to delete'))
                })
              }}
            >
